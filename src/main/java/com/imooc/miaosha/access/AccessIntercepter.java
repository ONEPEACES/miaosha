...
public class AccessIntercepter extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        if (handler instanceof HandlerMethod) {
            ...
            AccessKey ak = AccessKey.generateKey(seconds);
    ...
    private MiaoshaUser getUser(HttpServletRequest request, HttpServletResponse response) {
        String paramToken = request.getParameter(GlobalConst.COOKIE_NAME_TOKEN);
        String cookieToken = getCookieValue(request, GlobalConst.COOKIE_NAME_TOKEN);
